      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-3xl w-full mx-auto bg-white/10 border-2 border-white/30 rounded-2xl p-10 shadow-xl backdrop-blur-md">
          ...
          <div className="space-y-6 text-gray-100 text-lg">
            <p>
              Hello, I&apos;m Satria Aji. I am a Front-End Developer with
              experience in building responsive and user-friendly web interfaces
              using Next.js, Tailwind CSS, and HTML. During college, I actively
            ...
            <div>
              ...
              <p>
                ...
                &quot;Shalat Yuk!!!&quot;. In a group project, I took the role
                of front-end developer to create a music player website inspired
                by Spotify.
              </p>
            </div>
          </div>
